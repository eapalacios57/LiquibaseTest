    ...
    stages{
        stage('Pruebas') {
            steps {
                ...
                liquibase --defaultsFile=installerNoCode.properties --username=APP_BIRC_DEV --password=vwrmxcP3hdVxeUkj65py --url=jdbc:oracle:thin:@//190.85.106.202:1523/ORCLCDB.localdomain update'
